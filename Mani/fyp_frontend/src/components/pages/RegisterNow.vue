      ...
      <form class="space-y-6" @submit.prevent>
        ...
        <div>
          ...
          <input type="text" name="name" id="name"
            ...
            placeholder="John Doe" v-model.trim="name" required />
        </div>
        <div>
          <div class="flex items-center mb-4">
            <input id="caretaker" type="radio" value="caretaker" name="caretaker" v-model="role"
          ...
          <div class="flex items-center">
            <input checked id="careseeker" type="radio" value="careseeker" name="careseeker" v-model="role"
              class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
          Already registered?
          <router-link to="/login" class="text-blue-700 hover:underline dark:text-blue-500">Login
          </router-link>
        </div>
      </form>
    </div>
