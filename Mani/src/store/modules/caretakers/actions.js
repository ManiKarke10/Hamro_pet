...
export default {
  ...
  async getMyProfile(context) {
    ...
    let response = "";
    try {
      response = await axios.get("http://localhost:5000/api/v1/profiles", {
        headers: { Authorization: "Bearer " + token },
      });
  ...
  async updateMyProfile(context, payload) {
    ...
    /* const response = await axios({
      method: "patch",
      url: "http://localhost:5000/api/v1/profiles/updateMyProfile",
      headers: {
        Authorization: "Bearer " + token,
        "Content-Type": "multipart/form-data",
      },
    ...
    try {
      response = await axios.patch(
        "http://localhost:5000/api/v1/profiles/updateMyProfile",
        {
          ...profileData,
        },
        {
